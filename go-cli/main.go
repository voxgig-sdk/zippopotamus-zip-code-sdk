// Command ZippopotamusZipCode-cli is a CLI + REPL for the ZippopotamusZipCode SDK,
...
const prompt = "zippopotamus-zip-code"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "get_location_by_postal_code get_postal_codes_by_city"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ZIPPOPOTAMUS_ZIP_CODE_APIKEY (api key), ZIPPOPOTAMUS_ZIP_CODE_BASE (base url override)")
