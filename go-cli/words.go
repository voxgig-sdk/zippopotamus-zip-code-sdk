...
func registerSDKWords(r *eng.Registry, client *sdk.ZippopotamusZipCodeSDK) {
...
func runOp(client *sdk.ZippopotamusZipCodeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
