...
(0, node_test_1.describe)('GetLocationByPostalCodeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'get_location_by_postal_code.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['get_location_by_postal_code01', 'get_location_by_postal_code02', 'get_location_by_postal_code03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
