...
type ZippopotamusZipCodeSDK struct {
	Mode     string
...
func (sdk *ZippopotamusZipCodeSDK) OptionsMap() map[string]any {
...
func (sdk *ZippopotamusZipCodeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ZippopotamusZipCodeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ZippopotamusZipCodeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ZippopotamusZipCodeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ZippopotamusZipCodeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ZippopotamusZipCodeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ZippopotamusZipCodeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ZippopotamusZipCodeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ZippopotamusZipCodeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ZippopotamusZipCodeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ZippopotamusZipCodeSDK {
	...
	sdk := NewZippopotamusZipCodeSDK(sdkopts)
	sdk.Mode = "test"
