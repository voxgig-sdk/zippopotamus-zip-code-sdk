...
const testSeed = `map[string]any{"entity": map[string]any{"get_location_by_postal_code": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_postal_codes_by_city": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
