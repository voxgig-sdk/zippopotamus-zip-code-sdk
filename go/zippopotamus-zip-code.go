...
// instead of `sdk.NewZippopotamusZipCodeSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ZippopotamusZipCodeSDK  { return NewZippopotamusZipCodeSDK(nil) }
func Test() *ZippopotamusZipCodeSDK { return TestSDK(nil, nil) }
