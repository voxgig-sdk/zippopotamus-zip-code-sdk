...
#      offline in seeded test mode (ZippopotamusZipCodeSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ZippopotamusZipCode_sdk.rb")
  SDK_CLASS = "ZippopotamusZipCodeSDK"
  ...
  SDK_BASE = "ZippopotamusZipCode_sdk"
