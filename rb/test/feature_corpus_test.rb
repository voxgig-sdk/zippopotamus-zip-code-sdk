# ZippopotamusZipCode SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # ZippopotamusZipCodeSDK.new, not ZippopotamusZipCodeSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    ZippopotamusZipCodeSDK.new(opts)
  end
