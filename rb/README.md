...
The Ruby SDK for the ZippopotamusZipCode API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.ZippopotamusZipCode(nil).load(
  { "id" => "test01" }, nil
)
