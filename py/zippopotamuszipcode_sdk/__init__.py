...
from zippopotamuszipcode_sdk.utility import register

# Load features
from zippopotamuszipcode_sdk.feature.base_feature import ZippopotamusZipCodeBaseFeature
from zippopotamuszipcode_sdk.features import _has_feature, _make_feature
...
class ZippopotamusZipCodeSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ZippopotamusZipCodeUtility()
    ...
    def get_utility(self):
        return ZippopotamusZipCodeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ZippopotamusZipCodeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetLocationByPostalCode(self, data=None) -> "GetLocationByPostalCodeEntity":
        ...
        from zippopotamuszipcode_sdk.entity.get_location_by_postal_code_entity import GetLocationByPostalCodeEntity
    ...
    def GetPostalCodesByCity(self, data=None) -> "GetPostalCodesByCityEntity":
        ...
        from zippopotamuszipcode_sdk.entity.get_postal_codes_by_city_entity import GetPostalCodesByCityEntity
