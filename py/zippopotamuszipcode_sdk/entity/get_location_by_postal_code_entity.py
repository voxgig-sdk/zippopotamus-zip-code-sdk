...
from zippopotamuszipcode_sdk.zippopotamuszipcode_types import (
...
class GetLocationByPostalCodeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetLocationByPostalCodeEntity(self._client, opts)
    ...
    def data_get(self) -> GetLocationByPostalCode:
    ...
    def match_get(self) -> GetLocationByPostalCode:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GetLocationByPostalCode]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GetLocationByPostalCode().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
