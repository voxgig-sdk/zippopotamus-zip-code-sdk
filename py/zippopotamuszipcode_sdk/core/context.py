...
from zippopotamuszipcode_sdk.core.helpers import get_ctx_prop, to_map
...
class ZippopotamusZipCodeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ZippopotamusZipCodeControl()
        ...
        if isinstance(sp, ZippopotamusZipCodeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ZippopotamusZipCodeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ZippopotamusZipCodeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ZippopotamusZipCodeOperation({})
    ...
    def make_error(self, code, msg):
        return ZippopotamusZipCodeError(code, msg, self)
