# ZippopotamusZipCode SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from zippopotamuszipcode_sdk import ZippopotamusZipCodeSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"ZippopotamusZipCodeSDK": ZippopotamusZipCodeSDK, "os": os}
        try:
