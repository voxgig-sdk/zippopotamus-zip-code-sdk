# ZippopotamusZipCode SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ZippopotamusZipCodeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ZippopotamusZipCodeSDK(...) and ZippopotamusZipCodeSDK.test(...) become
#      ZippopotamusZipCodeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "zippopotamuszipcode_sdk"
_SDK_CLASS = "ZippopotamusZipCodeSDK"
...
_ENTITIES = {
    "GetLocationByPostalCode": "get_location_by_postal_code",
    "GetPostalCodesByCity": "get_postal_codes_by_city",
}
