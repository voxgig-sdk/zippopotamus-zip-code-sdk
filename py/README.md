# ZippopotamusZipCode Python SDK



The Python SDK for the ZippopotamusZipCode API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.GetLocationByPostalCode()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/zippopotamus-zip-code-sdk/releases)) or
...
```
py/
├── zippopotamuszipcode_sdk.py         -- Main SDK module
