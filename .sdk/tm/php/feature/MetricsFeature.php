...
// ZippopotamusZipCode SDK metrics feature
...
class ZippopotamusZipCodeMetricsFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    private function _record(ZippopotamusZipCodeContext $ctx, bool $ok): void
    {
