...
// ZippopotamusZipCode SDK telemetry feature
...
class ZippopotamusZipCodeTelemetryFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    private function _close(ZippopotamusZipCodeContext $ctx, bool $ok): void
    {
