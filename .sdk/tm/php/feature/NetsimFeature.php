...
// ZippopotamusZipCode SDK netsim feature
...
class ZippopotamusZipCodeNetsimFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    private function _simulate(ZippopotamusZipCodeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ZippopotamusZipCodeContext $ctx, array $applied): void
    {
        $client = $this->client;
