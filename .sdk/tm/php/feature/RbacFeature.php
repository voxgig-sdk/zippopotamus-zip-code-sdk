...
// ZippopotamusZipCode SDK rbac feature
...
class ZippopotamusZipCodeRbacFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    private function _required(ZippopotamusZipCodeContext $ctx): ?string
    {
    ...
    private function _reject(ZippopotamusZipCodeContext $ctx, string $required): void
    {
    ...
    private function _track(ZippopotamusZipCodeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
