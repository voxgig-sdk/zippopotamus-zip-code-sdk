...
// ZippopotamusZipCode SDK proxy feature
...
class ZippopotamusZipCodeProxyFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    public function init(ZippopotamusZipCodeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ZippopotamusZipCodeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
