...
// ZippopotamusZipCode SDK utility: fetcher

class ZippopotamusZipCodeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ZippopotamusZipCodeSDK/1.0)';
    ...
    public static function call(ZippopotamusZipCodeContext $ctx, string $fullurl, array $fetchdef): array
    {
