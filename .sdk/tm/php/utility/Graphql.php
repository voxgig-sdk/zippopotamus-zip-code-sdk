...
// ZippopotamusZipCode SDK utility: graphql
//
...
class ZippopotamusZipCodeGraphql
{
    ...
    // equivalent.
    public static function body(ZippopotamusZipCodeContext $ctx): mixed
    {
    ...
    public static function errors(ZippopotamusZipCodeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
