...
|---|---|---|
| `ts/` | @voxgig-sdk/zippopotamus-zip-code-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/zippopotamus-zip-code-sdk \
      --repository voxgig-sdk/zippopotamus-zip-code-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/zippopotamus-zip-code-sdk` shows it, and
`npm trust revoke @voxgig-sdk/zippopotamus-zip-code-sdk --id=<id>` removes it.
