...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_location_by_postal_code | get_postal_codes_by_city"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ZippopotamusZipCodeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "zippopotamus-zip-code_list",
		Description: "List records from ZippopotamusZipCode. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "zippopotamus-zip-code_load",
		Description: "Load a single record from ZippopotamusZipCode. " +
...
func runOp(client *sdk.ZippopotamusZipCodeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ZippopotamusZipCodeSDK, name string) (sdk.ZippopotamusZipCodeEntity, error) {
	switch strings.ToLower(name) {
	case "get_location_by_postal_code":
		return client.GetLocationByPostalCode(nil), nil
	case "get_postal_codes_by_city":
		return client.GetPostalCodesByCity(nil), nil
