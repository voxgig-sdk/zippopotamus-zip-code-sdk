// Command ZippopotamusZipCode-mcp is an MCP server exposing the ZippopotamusZipCode
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ZippopotamusZipCode_list  — list records of an entity
//	ZippopotamusZipCode_load  — load a single record of an entity
//
