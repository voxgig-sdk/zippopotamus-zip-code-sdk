...
local GetPostalCodesByCityEntity = {}
GetPostalCodesByCityEntity.__index = GetPostalCodesByCityEntity


function GetPostalCodesByCityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetPostalCodesByCityEntity)
...
function GetPostalCodesByCityEntity:get_name()
  return self._name
end


function GetPostalCodesByCityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetPostalCodesByCityEntity.new(self._client, opts)
end
...
function GetPostalCodesByCityEntity:mark_deleted()
  self._deleted = true
end


function GetPostalCodesByCityEntity:deleted()
  return true == self._deleted
end


function GetPostalCodesByCityEntity:data_set(args)
  if args ~= nil then
...
function GetPostalCodesByCityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetPostalCodesByCityEntity:match_set(args)
  if args ~= nil then
...
function GetPostalCodesByCityEntity:match_get()
...
function GetPostalCodesByCityEntity:stream(action, args, callopts)
...
---@param reqmatch GetPostalCodesByCityListMatch
---@param ctrl? table
---@return GetPostalCodesByCity[]
---@return string? err
function GetPostalCodesByCityEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function GetPostalCodesByCityEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetPostalCodesByCityEntity
