...
function GetLocationByPostalCodeEntity:mark_deleted()
  self._deleted = true
end


function GetLocationByPostalCodeEntity:deleted()
...
function GetLocationByPostalCodeEntity:stream(action, args, callopts)
