...
local SDK_MODULE = "zippopotamus-zip-code_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["get_location_by_postal_code"] = { ["test01"] = { id = "test01" } }, ["get_postal_codes_by_city"] = { ["test01"] = { id = "test01" } } } }'
