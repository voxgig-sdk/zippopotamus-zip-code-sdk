...
describe("GetLocationByPostalCodeEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ZIPPOPOTAMUS_ZIP_CODE_TEST_GET_LOCATION_BY_POSTAL_CODE_ENTID JSON to run live")
      return
    end
...
function get_location_by_postal_code_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ZIPPOPOTAMUS_ZIP_CODE_TEST_GET_LOCATION_BY_POSTAL_CODE_ENTID")
