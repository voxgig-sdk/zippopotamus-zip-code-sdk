...
function runner.env_override(m)
  local live = runner.getenv("ZIPPOPOTAMUS_ZIP_CODE_TEST_LIVE")
  local override = runner.getenv("ZIPPOPOTAMUS_ZIP_CODE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ZIPPOPOTAMUS_ZIP_CODE_TEST_EXPLAIN")
