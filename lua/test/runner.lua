...
function runner.env_override(m)
  local live = runner.getenv("ZIPPOPOTAMUSZIPCODE_TEST_LIVE")
  local override = runner.getenv("ZIPPOPOTAMUSZIPCODE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ZIPPOPOTAMUSZIPCODE_TEST_EXPLAIN")
