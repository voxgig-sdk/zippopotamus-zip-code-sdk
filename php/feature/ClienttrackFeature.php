...
// ZippopotamusZipCode SDK clienttrack feature
...
class ZippopotamusZipCodeClienttrackFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    public function PostConstruct(ZippopotamusZipCodeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ZippopotamusZipCode-SDK';
