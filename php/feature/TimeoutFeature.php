...
// ZippopotamusZipCode SDK timeout feature
...
class ZippopotamusZipCodeTimeoutFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    private function _with_timeout(ZippopotamusZipCodeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ZippopotamusZipCodeContext $_ctx, float $ms): void
    {
        $client = $this->client;
