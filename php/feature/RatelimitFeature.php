...
// ZippopotamusZipCode SDK ratelimit feature
...
class ZippopotamusZipCodeRatelimitFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    private function _acquire(ZippopotamusZipCodeContext $ctx): void
    {
    ...
    private function _track(ZippopotamusZipCodeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
