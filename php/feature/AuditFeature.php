...
// ZippopotamusZipCode SDK audit feature
...
class ZippopotamusZipCodeAuditFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    private function _emit(ZippopotamusZipCodeContext $ctx, string $outcome): void
    {
