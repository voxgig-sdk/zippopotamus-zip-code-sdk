...
// ZippopotamusZipCode SDK debug feature
...
class ZippopotamusZipCodeDebugFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    private function _finish(ZippopotamusZipCodeContext $ctx, bool $ok): void
    {
