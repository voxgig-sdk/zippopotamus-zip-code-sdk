...
// ZippopotamusZipCode SDK streaming feature
...
class ZippopotamusZipCodeStreamingFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    private function _iterate(ZippopotamusZipCodeResult $result): \Generator
    {
    ...
    private function _streamable(ZippopotamusZipCodeContext $ctx): bool
    {
