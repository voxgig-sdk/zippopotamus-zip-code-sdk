...
// ZippopotamusZipCode SDK cache feature
...
class ZippopotamusZipCodeCacheFeature extends ZippopotamusZipCodeBaseFeature
{
    ...
    private function _through(ZippopotamusZipCodeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
