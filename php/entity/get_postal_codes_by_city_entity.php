...
class GetPostalCodesByCityEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "get_postal_codes_by_city";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GetPostalCodesByCityEntity($this->_client, $opts);
    }

    /**
     * @param GetPostalCodesByCity|array $args GetPostalCodesByCity data (assoc-array) to store.
     */
    ...
    /**
     * @return GetPostalCodesByCity|array The current GetPostalCodesByCity data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetPostalCodesByCity fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetPostalCodesByCity fields).
     */
     ...
     *
     * @param GetPostalCodesByCityListMatch|array|null $reqmatch Match filter (any subset
     *   of GetPostalCodesByCity fields) as an assoc-array; GetPostalCodesByCityListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetPostalCodesByCity[]|array A list of GetPostalCodesByCity items as assoc-arrays at
