...
class ZippopotamusZipCodeSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $utility = new ZippopotamusZipCodeUtility();
        ...
        $feature_opts = ZippopotamusZipCodeHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ZippopotamusZipCodeHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ZippopotamusZipCodeFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ZippopotamusZipCodeFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ZippopotamusZipCodeUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ZippopotamusZipCodeHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ZippopotamusZipCodeHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ZippopotamusZipCodeHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ZippopotamusZipCodeError($op . "_allow",
                "ZippopotamusZipCodeSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ZippopotamusZipCodeHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ZippopotamusZipCodeError("graphql_error",
                "ZippopotamusZipCodeSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetLocationByPostalCode($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_location_by_postal_code === null) {
                $this->_get_location_by_postal_code = new GetLocationByPostalCodeEntity($this, null);
            }
            return $this->_get_location_by_postal_code;
        }
        return new GetLocationByPostalCodeEntity($this, $data);
    }
    ...
    public function GetPostalCodesByCity($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_postal_codes_by_city === null) {
                $this->_get_postal_codes_by_city = new GetPostalCodesByCityEntity($this, null);
            }
            return $this->_get_postal_codes_by_city;
        }
        return new GetPostalCodesByCityEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new ZippopotamusZipCodeSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
