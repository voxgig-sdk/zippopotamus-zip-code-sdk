# ZippopotamusZipCode PHP SDK

The PHP SDK for the ZippopotamusZipCode API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetLocationByPostalCode(null)->list(null, null);
...
[$result, $err] = $client->ZippopotamusZipCode(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── zippopotamuszipcode_sdk.php          -- Main SDK class
...
The main class (`zippopotamuszipcode_sdk.php`) exports the SDK class
