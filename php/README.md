...
The PHP SDK for the ZippopotamusZipCode API — an entity-oriented client using PHP conventions.
...
```php
[$result, $err] = $client->GetLocationByPostalCode()->list();
...
[$result, $err] = $client->ZippopotamusZipCode()->load(["id" => "test01"]);
