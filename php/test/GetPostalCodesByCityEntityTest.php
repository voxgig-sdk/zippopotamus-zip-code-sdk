...
class GetPostalCodesByCityEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ZIPPOPOTAMUS_ZIP_CODE_TEST_GET_POSTAL_CODES_BY_CITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function get_postal_codes_by_city_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ZIPPOPOTAMUS_ZIP_CODE_TEST_GET_POSTAL_CODES_BY_CITY_ENTID");
