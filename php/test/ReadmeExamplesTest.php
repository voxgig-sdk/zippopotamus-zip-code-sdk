...
// ZippopotamusZipCode SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ZippopotamusZipCodeSDK::test)
...
{
    private const SDK_CLASS = 'ZippopotamusZipCodeSDK';
    ...
    private const SDK_BASE = 'zippopotamuszipcode_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../zippopotamuszipcode_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
