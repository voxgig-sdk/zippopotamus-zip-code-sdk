...
// ZippopotamusZipCode SDK utility type

class ZippopotamusZipCodeUtility
{
    ...
    public static function copy(ZippopotamusZipCodeUtility $src): ZippopotamusZipCodeUtility
    {
        $u = new ZippopotamusZipCodeUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
