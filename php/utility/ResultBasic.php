...
// ZippopotamusZipCode SDK utility: result_basic

class ZippopotamusZipCodeResultBasic
{
    public static function call(ZippopotamusZipCodeContext $ctx): ?ZippopotamusZipCodeResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ZippopotamusZipCodeError) ? $result->err->msg : (string)$result->err;
