...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/zippopotamus-zip-code` | `npm install @voxgig-sdk/zippopotamus-zip-code` |
| Python | `voxgig-sdk-zippopotamus-zip-code` | `pip install voxgig-sdk-zippopotamus-zip-code` |
| PHP | `voxgig-sdk/zippopotamus-zip-code` | `composer require voxgig-sdk/zippopotamus-zip-code` |
| Golang | `github.com/voxgig-sdk/zippopotamus-zip-code-sdk/go` | `go get github.com/voxgig-sdk/zippopotamus-zip-code-sdk/go` |
| Ruby | `voxgig-sdk-zippopotamus-zip-code` | `gem install voxgig-sdk-zippopotamus-zip-code` |
| Lua | `voxgig-sdk-zippopotamus-zip-code` | `luarocks install voxgig-sdk-zippopotamus-zip-code` |
